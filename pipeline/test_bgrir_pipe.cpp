...
void test_bgrir_pipeline(pipeline_manager* manager)
{
    ...
    awbgain_hw* awb_gain_hw_inst = new awbgain_hw(1, 1, "awb_gain_hw");
    ...
    manager->register_hw_module(awb_gain_hw_inst);
    ...
    manager->connect_port(rgbir_remosaic_hw_inst, 0, awb_gain_hw_inst, 0); //raw data
    manager->connect_port(awb_gain_hw_inst, 0, demosaic_hw_inst, 0); //raw data
}