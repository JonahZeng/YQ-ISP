...
yuv2rgb_8b::yuv2rgb_8b(uint32_t inpins, uint32_t outpins, const char* inst_name):hw_base(inpins, outpins, inst_name), yuv2rgb_coeff(9, 0)
{
    bypass = 0;
    yuv2rgb_8b_reg = new yuv2rgb_8b_reg_t;
}

void yuv2rgb_8b::hw_run(statistic_info_t* stat_out, uint32_t frame_cnt)
{
...
void yuv2rgb_8b::checkparameters(yuv2rgb_8b_reg_t* reg)
{
