...
yuv422_conv::yuv422_conv(uint32_t inpins, uint32_t outpins, const char* inst_name):hw_base(inpins, outpins, inst_name)
{
...
void yuv422_conv::checkparameters(yuv422_conv_reg_t* reg)
{
