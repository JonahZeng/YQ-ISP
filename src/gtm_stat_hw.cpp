...
gtm_stat_hw::gtm_stat_hw(uint32_t inpins, uint32_t outpins, const char* inst_name) :hw_base(inpins, outpins, inst_name)
{
    bypass = 0;
    rgb2y.resize(3);
    w_ratio = 2;
...
void gtm_stat_hw::hw_run(statistic_info_t* stat_out, uint32_t frame_cnt)
{
...
void gtm_stat_hw::checkparameters(gtm_stat_reg_t* reg)
{
