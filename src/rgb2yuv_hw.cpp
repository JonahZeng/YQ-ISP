...
rgb2yuv_hw::rgb2yuv_hw(uint32_t inpins, uint32_t outpins, const char* inst_name):hw_base(inpins, outpins, inst_name), rgb2yuv_coeff(9, 0)
{
    bypass = 0;
    rgb2yuv_reg = new rgb2yuv_reg_t;
}

void rgb2yuv_hw::hw_run(statistic_info_t* stat_out, uint32_t frame_cnt)
{
...
void rgb2yuv_hw::checkparameters(rgb2yuv_reg_t* reg)
{
